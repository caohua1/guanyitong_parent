package com.guanyitong.controller.yinlianPay.payAction;

import com.guanyitong.controller.yinlianPay.sdk.AcpService;
import com.guanyitong.controller.yinlianPay.sdk.LogUtil;
import com.guanyitong.controller.yinlianPay.sdk.SDKConfig;
...
public class Form05_6_2_AppConsume {
    ...
    public void yinlianPay(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        //商户号777290058110048
        ...
        contentData.put("signMethod", "02"); //签名方法
