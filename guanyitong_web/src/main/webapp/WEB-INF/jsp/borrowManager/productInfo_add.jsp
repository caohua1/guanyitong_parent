...
<div class="iframe_acont">
    ...
    <form>
        <div class="angcon">
            <p><span>用户借款ID：</span><span><input type="text" id="borrowMoneyUserId"></span></p>
            <p><span>产品名称：</span><span><input type="text" id="NO"></span></p>



            <p><span>预期年化收益：：</span><span><input type="text" id="yield"></span></p>
            ...
            <p><span>借款金额：</span><span><input type="text" id="ZMoney"></span></p>
            <p><span>还款方式：</span>
                <span><select id="backMoneyType">
						<option value="-1" selected="selected">请选择还款方式</option>
            ...
            <p><span>筹标时间:</span><span><input type="text" onfocus="MyCalendar.SetDate(this)" class="input-text" id="startRaiseTime"></span>
                <span>至</span><span><input type="text" onfocus="MyCalendar.SetDate(this)" class="input-text" id="endRaiseTime"></span>
            </p>
            <p><span>借款期限：</span>
            ...
            <p><span>借款时间:</span><span><input type="text" onfocus="MyCalendar.SetDate(this)" class="input-text" id="startBorrowTime"></span>
                <span>至</span><span><input type="text" onfocus="MyCalendar.SetDate(this)" class="input-text" id="endBorrowTime"></span>
            </p>
