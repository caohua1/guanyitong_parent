...
/** 
 ...
  * 
  */
    public static String checkIdCard(String idCard) throws ParseException{
        ...
        //18位身份证前17位为数字，如果是15位的身份证号则所有的号码都为数字
        if(idCard.length()==18){
    ...
    public static boolean isDate(String strDate){
      Pattern pattern=Pattern.compile("^\\d{4}-0[1-9]|1[1-2]-0[1-9]|[1-2]\\d|3[0-1] [0-2][0-4]:[0-6]\\d:[0-6]\\d$");
